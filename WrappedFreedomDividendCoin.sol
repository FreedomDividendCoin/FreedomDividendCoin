...
/**
 * @title WrappedFreedomDividendCoin BEP20 token
 *
 ...
 */
contract WrappedFreedomDividendCoin is IERC20,ERC20Detailed {
    ...
    string private _name="Wrapped Freedom Dividend Coin";

    string private _symbol="WFDC";
    ...
    */
    ...
    address private DividendDistributor = address(this);
    ...
    public
    {
        ...
        balanceOfDividendDistributorAtDistributionTimestamp = 200000000;
    }
